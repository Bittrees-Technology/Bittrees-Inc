...
const revisionKey = "bittrees:registry:revision";
  ...
  return async (req, res) => {
    try {
      ...
      if (req.method === "POST") {
        ...
        const audience =
          process.env.REGISTRY_AUDIENCE || "https://gov.bittrees.org";
        if (
          e.version !== 2 ||
          e.audience !== audience ||
          e.chainId !== 1 ||
      ...
      if (status >= 200 && status < 300 && c.signed) {
        ...
        const result = (
          await command([
            ...
            3,
            revisionKey,
            "bittrees:registry:nonce:" + c.signer + ":" + e.nonce,
            "bittrees:registry:audit",
            String(revision),
