...
export async function authorityDecision(actor,action){
 ...
 const request={source:'gov.bittrees.org',scope:'gov',audience:endpoint,actor:actor.toLowerCase(),action,resource:'community-registry',issuedAt:Date.now(),requestId:randomUUID()};
