...
export function ChatRecoveryExport() {
  ...
  function preview() {
    ...
    try { if (!address) throw new Error('Connect your wallet first.'); setReview(reviewChatExport(localStorage, address, shared, 'governance')); }
  ...
  async function download() {
    ...
    try {
      ...
      try {
        const link = document.createElement('a'); link.href = url; link.download = 'chat-governance-recovery.json';
